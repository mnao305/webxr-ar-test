...
import { ARButton } from "./WebXRButton.js"
...
function init() {
  ...
  document.body.appendChild(
    ARButton(renderer, { requiredFeatures: ["hit-test"] })
  )
  ...
  reticle = new THREE.Mesh(
    new THREE.RingBufferGeometry(0.03, 0.04, 32).rotateX(-Math.PI / 2),
  ...
  if (frame) {
    ...
    if (hitTestSource) {
      ...
      if (hitTestResults.length) {
        ...
        const position = hit.getPose(xrRefSpace).transform.position
